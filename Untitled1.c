...
void main(){
    ...
    int b, j, n, k , r, p, z, temp, factor, previous=0, ZP=0, sum=1, afthonoi=0, elattomatikoi=0;
    ...
    int mobius=0;
    int w, riza;														/*metablites gia upologismo tetragwnikis rizas*/				
    ...
    for(b=2;b<=y;b++){
		...
		if((sum)==b){
        	...
        	//printf("o elattomatikos arithmos einai: %d\n\n", b);
        }
        else if((sum)>b){
        	afthonoi++;
        	//printf("H souma einai: %d\n", sum);
